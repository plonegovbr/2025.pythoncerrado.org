...
Install pythoncerrado.site with uv.

```shell
uv add pythoncerrado.site
```
...
- [Issue tracker](https://github.com/plonegovbr/2025.pythoncerrado.org/issues)
- [Source code](https://github.com/plonegovbr/2025.pythoncerrado.org/)
...
1.  Clone this repository.
    ...
    cd 2025.pythoncerrado.org/backend
    ```
...
Generated from the [`cookieplone-templates`  template](https://github.com/plone/cookieplone-templates/tree/main/) on 2025-05-23 19:34:08.. A special thanks to all contributors and supporters!
