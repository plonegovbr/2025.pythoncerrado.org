...
if site_id not in app.objectIds():
    ...
    portal_setup.runAllImportStepsFromProfile("profile-pythoncerrado.site:default")
    transaction.commit()

    if EXAMPLE_CONTENT:
        portal_setup.runAllImportStepsFromProfile("profile-pythoncerrado.site:demo")
        transaction.commit()
    app._p_jar.sync()
